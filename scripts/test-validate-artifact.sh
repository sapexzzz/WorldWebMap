...
"$validator" fabric "$root/build/libs/fabricwebmap-0.2.2.jar"
...
negative fabric fabric-license '{"version":"0.2.2","license":"MIT","depends":{"fabricloader":">=0.15.11","minecraft":"~1.20.1"}}' fabric.mod.json
