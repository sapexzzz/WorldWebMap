...
World Web Map — серверная веб-карта для Minecraft **1.20.1** на **Fabric** и **Forge**. Мод показывает исследованную местность в браузере; клиентский мод игрокам не нужен.
...
- [Релизы GitHub](https://github.com/sqwiziiy/World-Web-Map/releases)
- [Modrinth](https://modrinth.com/mod/mentalitys-world-web-map)
- [Ошибки и предложения](https://github.com/sqwiziiy/World-Web-Map/issues)
- [Карта веток](docs/BRANCHES.md)
...
`main` содержит только информацию о проекте и не предназначена для исходного кода или сборки. Исходный код находится в `2.2fabric` и `2.2forge`; `2.1fabric` и `2.1forge` сохранены как архивные снимки. Выбирайте JAR для своего загрузчика: Fabric JAR не является Forge JAR, и наоборот.

В реализации используются Java, а также JavaScript, CSS и HTML для интерфейса карты в браузере.
