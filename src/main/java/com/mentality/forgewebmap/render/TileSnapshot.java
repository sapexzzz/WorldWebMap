...
public final class TileSnapshot {
    ...
    /** Packed ARGB color per pixel. */
    public final int[] colors;

    /** World surface height (Y) per pixel, used for height shading. */
     ...
     * Used by TileRenderer to composite over the existing tile file
     * instead of overwriting good pixels with placeholders.
     */
    ...
    public TileSnapshot(String webDimension, int tileX, int tileZ, int zoom, int tileSize,
                        int[] colors, int[] heights, boolean[] loadedMask) {
        this.dimension = null;
