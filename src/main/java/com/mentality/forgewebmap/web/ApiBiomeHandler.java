 ...
 * The query runs on the HTTP thread via a volatile server reference —
 * biome lookups only read the static noise data stored in the chunk,
 * which is safe to do off the main thread (no live gameplay data).
 *
...
public class ApiBiomeHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        // Parse ?dim=overworld&x=100&z=200
        String dim = null;
     ...
     * somemod:custom_magic_biome   → [somemod] Custom Magic Biome
     */
    private static String formatBiomeName(String id) {
        ...
        // Show mod prefix only for non-vanilla biomes
